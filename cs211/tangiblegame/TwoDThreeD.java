...
public class TwoDThreeD {
    ...
    private double[][] solveExtrinsicMatrix(List<PVector> points2D) {
        ...
        points2D = convertToHomogeneousCoords(points2D);
    ...
    private List<PVector> convertToHomogeneousCoords(List<PVector> points2D) {
        List<PVector> convertedPoints = new ArrayList<>();

        for (PVector v : points2D) {
            convertedPoints.add(new PVector(v.x, v.y, 1));
        }
