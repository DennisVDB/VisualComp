...
class Mover extends PApplet {
    ...
    public void update(double angleX, double angleZ) {
    ...
    private PVector accountForGravity(PVector velocity, double angleX, double angleZ) {
        float gravity = 3;

        return (new PVector(gravity * sin((float) angleZ), 0, gravity * sin((float) angleX)));
    }
