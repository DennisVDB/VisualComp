...
//    }
    ...
    public void getCorner(PImage image) {
...
//        result = hueBrightnessSaturationThresholding(image);
...
//        quadGraph.build(lines, image.width, image.height);
//
...
//        }
//
//        corners.add(lines.get(quad[0]));
//        corners.add(lines.get(quad[1]));
//        corners.add(lines.get(quad[2]));
//        corners.add(lines.get(quad[3]));
//
//        return corners;
//        return null;
    }
